...
TXT;
        ...
        $this->assertStringContainsString('Total Premium', $html);
        $this->assertStringContainsString('Basic Premium', $html);
        $this->assertStringContainsString('PHCF', $html);
        $this->assertStringContainsString('50.00', $html);
        $this->assertStringContainsString('Training Levy', $html);
        $this->assertStringContainsString('TOR', $html);
